...
templateDialog.Configure({
        dialog: "#changeInstructorDialog",
        activatingButton: "#changeInstructorLink",
        okButtonText: "Yes, change instructor",
        onOK: function() {
        ...
        loadingTemplate: "#emptyChangeInstructorTemplate",
        displayTemplate: "#changeInstructorTemplate"
    });
